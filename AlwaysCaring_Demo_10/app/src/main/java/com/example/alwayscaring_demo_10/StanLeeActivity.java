...
public class StanLeeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSchedule.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent returnpg= new Intent(StanLeeActivity.this,ScheduleActivity.class);
    ...
    public void onCheckboxClicked(View view) {
        ...
        if(checked = true) {
            ...
            switch (view.getId()) {
                case R.id.task_1:
                    mTextViewTask1.setText(currentDate + ": Folding Clothes was completed at " + currentTime);
                    task1.setEnabled(false);
                    break;
                case R.id.task_2:
                    mTextViewTask2.setText(currentDate + ": Starting Laundry was completed at " + currentTime);
                    task2.setEnabled(false);
                    break;
                case R.id.task_3:
                    mTextViewTask3.setText(currentDate + ": Cooking Dinner was completed at " + currentTime);
