...
public class FrankActivity extends AppCompatActivity {
    ...
    public void onCheckboxClicked(View view) {
        ...
        if(checked = true) {
            ...
            switch (view.getId()) {
                case R.id.task_1:
                    mTextViewTask1.setText(currentDate + ": Making Steven lunch was completed at " + currentTime);
                    task1.setEnabled(false);
                    break;
                case R.id.task_2:
                    mTextViewTask2.setText(currentDate + ": Helping in Garden was completed at" + currentTime);
                    task2.setEnabled(false);
                    break;
                case R.id.task_3:
                    mTextViewTask3.setText(currentDate + ": Steven given medication was completed at" + currentTime);
