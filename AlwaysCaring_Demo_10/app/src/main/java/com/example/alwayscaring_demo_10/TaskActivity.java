...
public class TaskActivity extends AppCompatActivity {
    ...
    public void onCheckboxClicked(View view) {
        ...
        if(checked = true) {
            ...
            switch (view.getId()) {
                case R.id.task_1:
                    mTextViewTask1.setText(currentDate + ":Washing Dishes was completed at " + currentTime);
                    task1.setEnabled(false);
                    break;
                case R.id.task_2:
                    mTextViewTask2.setText(currentDate + ": Letting Cynthia Nap was completed at " + currentTime);
                    task2.setEnabled(false);
                    break;
                case R.id.task_3:
                    mTextViewTask3.setText(currentDate + ": Talking to Cynthina was completed at " + currentTime);
